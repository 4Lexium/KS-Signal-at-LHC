                     ...
                     TH1F *hZ)
{
    ...
    if (var == "m_l2jj") {
        hs_bkg->SetMaximum(7.95e4);   //1.19e4 for 500fb: 1.99e5  for 3fb:1.39e3  // FNAL: 2.75e3     (SS: 2.99e3)
    } else if (var == "m_jj") {
        hs_bkg->SetMaximum(1.5e7);    //1.5e4   for 500fb:1.5e5   for 3fb:1.5e3
        hs_bkg->SetMinimum(9e-2);   //1.5e-3  for 500fb:1.5e-2   for 3fb:1.5e-4
    } else if (var == "m_lljj" ) {
        hs_bkg->SetMaximum(4.95e4);   //1.19e4 for 500fb:1.99e5    for 3fb:1.39e3   // FINAL: 2.75e3   (SS1.99e3)
        ...
        hs_bkg->SetMinimum(9e-2);
    } else if (var == "lep1_pt") {
        hs_bkg->SetMaximum(1.5e9);    //1.5e7  for 500fb:1.5e8    for 3fb:1.5e6
        hs_bkg->SetMinimum(9e-2);
    } else if (var == "lep2_pt") {
        hs_bkg->SetMaximum(1.5e9);    //1.5e7  for 500fb:1.5e8    for 3fb:1.5e6
        hs_bkg->SetMinimum(9e-2);
...
void SIGvsBKG_data22() { 
    ...
    bool use_metadata_totalW = true;
    std::cout << "User Test 086:" << std::endl;
    std::string output_dir = "/home/alexanum/WORKSPACE/testing/MadGraph5/analysis/SIGvsBKG_RECO/Figures/SIGvsBKG_reco2_500fb_nodat2";
