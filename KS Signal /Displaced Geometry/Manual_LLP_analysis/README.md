...
Nominal Displacement calculated using (HNL_witdth_eq.png) is plotted as function of ($m_N, m_{W_R}$) and compared to SM neutral states (see Nominal_samples.png)
